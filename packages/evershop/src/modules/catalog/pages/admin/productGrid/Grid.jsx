  ...
  const actions = [
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Disable ${length} products', {length: selectedIds.length}),
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Enable ${length} products', {length: selectedIds.length}),
          content: _('Are you sure?'),
          primaryAction: {
            title: _('Cancel'),
            onAction: closeAlert,
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Delete ${length} products', {length:selectedIds.length}),
